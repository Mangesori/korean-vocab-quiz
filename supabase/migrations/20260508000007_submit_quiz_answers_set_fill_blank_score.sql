-- Fix: set fill_blank_score/fill_blank_total at insert time so the score is visible
-- immediately in teacher dashboard, not just after final submission.
...
BEGIN
  ...
  -- fill_blank_score/total을 INSERT 시점에 바로 저장
